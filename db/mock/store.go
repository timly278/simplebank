...
// Source: github.com/timly278/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TransferTxPrams) (db.TransferTxResults, error) {
	m.ctrl.T.Helper()
