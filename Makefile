...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/timly278/simplebank/db/sqlc Store

.PHONY: postgres createdb dropdb migrateup1 migratedown1 sqlc migratecreate server mock
